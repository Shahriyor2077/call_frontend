...
const inputCls = "w-full py-2.5 rounded-xl border border-slate-600/60 bg-slate-700/50 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:bg-slate-700 focus:border-violet-500/60 focus:ring-2 focus:ring-violet-500/20 transition-all";
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-3xl border border-slate-700/60 p-8" style={{ background: 'rgba(255,255,255,0.04)', backdropFilter: 'blur(12px)' }}>
          <div className="flex items-center gap-3 mb-8">
            <div className="w-11 h-11 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-900/40" style={{ background: 'linear-gradient(135deg, #7c3aed, #6d28d9)' }}>
              <Shield size={20} className="text-white" />
            </div>
            <div>
              <h2 className="font-bold text-white text-lg leading-tight">Superadmin</h2>
              <p className="text-xs text-slate-400">Tizimga kirish</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 rounded-xl text-white text-sm font-semibold transition-all duration-200 hover:shadow-lg hover:shadow-violet-900/50 hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-60 disabled:cursor-not-allowed mt-2"
