...
const STATUS_INFO: Record<string, { label: string; dot: string; iconBg: string }> = {
    NEW:         { label: 'Yangi',     dot: 'bg-blue-500',   iconBg: 'bg-blue-500' },
    IN_PROGRESS: { label: 'Muloqotda', dot: 'bg-amber-500',  iconBg: 'bg-amber-500' },
    ENROLLED:    { label: 'Yozildi',   dot: 'bg-green-500',  iconBg: 'bg-green-500' },
    NOT_COME:    { label: 'Kelmadi',   dot: 'bg-gray-400',   iconBg: 'bg-gray-400' },
    REJECTED:    { label: 'Rad etdi',  dot: 'bg-red-500',    iconBg: 'bg-red-500' },
};
