...
const COLUMNS = [
    ...
    { key: 'IN_PROGRESS', label: "Bog'lanildi", dot: 'bg-amber-500',  badge: 'bg-amber-50 text-amber-700' },
    { key: 'ENROLLED',    label: 'Qiziqyapti', dot: 'bg-violet-500', badge: 'bg-violet-50 text-violet-700' },
        ...
        <div className="max-w-4xl">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-3 flex-wrap">
                            <div>
                                ...
                                <a
                                    href={`tel:${lead.phone}`}
                                    className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-indigo-600 mt-0.5 transition-colors"
                                >
                                    <Phone size={13} />
                                    {lead.phone}
                                </a>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="col-span-2">
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <Button onClick={() => void updateLead()} loading={saving} className="flex-1">
                                Saqlash
                            </Button>
                            <button
                ...
                <div className="space-y-4">
                    ...
                    {lead.operator && (
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Operator</p>
                            <div className="flex items-center gap-3">
                                <Avatar name={lead.operator.name} size="md" />
                                <div>
                                    <p className="text-sm font-semibold text-gray-900">{lead.operator.name}</p>
                                    <p className="text-xs text-gray-400">Mas&apos;ul operator</p>
                                </div>
                            </div>
                        </div>
                    )}
